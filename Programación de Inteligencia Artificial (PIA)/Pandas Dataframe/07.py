...
# Añadir columna 'Aprobado' (True si Promedio General >= 5, False si no)
df_alumnos["Aprobado"] = df_alumnos["Promedio General"] >= 5

# Agrupar y contar cuántos alumnos hay en cada grupo (Aprobado/No Aprobado)
resultado = df_alumnos["Aprobado"].value_counts()

# Mostrar los resultados
print("Número de alumnos en cada grupo (Aprobado/No Aprobado):")
print(resultado)
